...
@pytest.fixture
def sample_request() -> FraudPredictionRequest:
    return FraudPredictionRequest(**SAMPLE_TRANSACTION)


@pytest.fixture
def mock_model_service():
    """A fully mocked ModelService ready for injection."""
    svc = MagicMock()
    svc.is_ready = True
    svc.model_version = "xgboost-v1"
    svc.predict.return_value = (False, 0.05)
    svc.predict_batch.return_value = [(False, 0.05), (True, 0.93)]
    return svc
